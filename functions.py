...
def use_loot(belt, hero):
    good_loot_options = ["Apple","Bread","Health Potion", "Leather Boots"]
    bad_loot_options = ["Broken Glass","Poison Potion"]
...
def hero_attacks(hero, monster,belt): #added this
    ascii_image = """
                                @@   @@ 
                                @    @  
                                @   @   
  ...
  """
    ...
    if hero.health_points <= 10 and "Health Potion" in belt:
            ...
            attack_power = hero.combat_strength * 2
    else:
        attack_power = hero.combat_strength    #to here added this
